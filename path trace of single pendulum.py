...
#PLotting the data:
#Creating graphs showing the change in values
ax1.plot(x2, y2, c="black")
ax2.plot(theta1, theta2, c="black")


#Presenting the plot nicely
ax1.set(xlim=[-2.5, 2.5], ylim=[-2.5, 2.5], xlabel="mass2 x", ylabel="mass2 y")
ax2.set(xlabel="theta1", ylabel="theta2")
